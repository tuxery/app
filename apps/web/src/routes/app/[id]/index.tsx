...
export const useApp = routeLoader$(async (requestEvent): Promise<CatalogApp | null> => {
  ...
  const app = await getAppById(requestEvent.platform.env, id);
    ...
    return (
      <div class="text-center py-24">
        ...
        <p class="text-base-content/60 mb-4">
          It may not be in the loaded dataset — run <code class="font-mono">pnpm seed</code> in{" "}
          <code class="font-mono">tuxery/catalog</code> for a local one.
        </p>
